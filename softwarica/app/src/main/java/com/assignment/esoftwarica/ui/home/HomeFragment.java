...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        Students students = new Students("admin", "Newroad", "Female", "21",R.drawable.femaleimg);
        studentsList = students.getStudentsList();
        if (studentsList.isEmpty()){
            studentsList.add(new Students("Beraj Ranjit", "boudha", "Male", "22", R.drawable.maleimg));
            studentsList.add(new Students("Akriti Gurung", "biratnagar", "Female", "20", R.drawable.femaleimg));
